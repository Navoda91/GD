...
namespace AgentWindy
{
	...
	public class Game1 : Game
	{
		...
		SpriteFont life, timelife, counDown;
		...
		protected override void Update (GameTime gameTime)
		{
			...
			//Increase the #of lives of the agent when the agent grabs healthy mushrooms
			...
			//Decrease Live: Agent grabs poisonous mushrooms or hits fireballs
